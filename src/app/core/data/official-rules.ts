...
/** Shown below the official rules — not a numbered rule. */
export const OFFICIAL_RULING_NOTE =
  'If there are any questions about the rules, contact Luke or anyone in his group for an official ruling.';
